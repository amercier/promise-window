(function(QUnit, require) {
  'use strict';
  require(['promise-window'], function(PromiseWindow) {
  ...
  window.QUnit,
  window.require || function requireGlobal(dependencies, callback) {
    'use strict';
    callback.apply(this, dependencies.map(function(name) {
      // hyphen-cased => PascalCased
      return window[name.replace(/(^|-)([a-z])/g, function (g1, g2, g3) {
        return (g3||g1).toUpperCase();
      })];
    }));
  }
);
